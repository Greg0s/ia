...
const gui = new GUI();
const params = {
  Lorenz: () => attractor("lorenz"), // Draw 10,000 Lorenz attractor points
  Rossler: () => attractor("rossler"), // Draw 10,000 Rossler attractor points
  Aizawa: () => attractor("aizawa"), // Draw 10,000 Aizawa attractor points
  clear: () => {
    clearScene();
  },
};
